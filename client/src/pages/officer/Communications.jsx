...
3. This issues with the approval of the competent authority.`,
  ...
  SANCTION: {
    ...
    body: (a) => `Sanction of the President is hereby accorded to the payment of scholarship under the ${a.scheme?.name} for the academic year ${a.academicYear} in favour of ${a.personal?.fullName}, ${a.academic?.course}, ${a.academic?.institution}, against application number ${a.applicationId}.
...
5. This issues with the concurrence of the Integrated Finance Division.`,
  },
  REJECTION: {
...
export default function Communications() {
  ...
  const letterNo = application
    ? `F. No. 17-${String(application.applicationId).slice(-4)}/2026-Sch.`
    : 'F. No. 17-____/2026-Sch.';

  return (
    <DashboardLayout
      breadcrumbs={[{ label: 'Communications' }]}
      title="Generate Communications"
      intro="Draft the standard letters issued by the Scholarship Division against an application. The draft is placed on file for approval by the competent authority before issue."
    >
          ...
          {!application ? (
            ...
            <article id="letter-body" className="mx-auto max-w-3xl border border-govgrey-300 bg-white p-7 leading-relaxed">
              <header className="mb-5 text-center">
                <p className="text-gov-table font-semibold uppercase tracking-wide text-govgrey-700">
                  Government of India
                </p>
                <p className="text-gov-card font-bold text-navy">Ministry of Tribal Affairs</p>
                <p className="text-gov-table text-govgrey-600">Scholarship Division</p>
                <p className="text-gov-xs text-govgrey-600">Shastri Bhawan, New Delhi — 110001</p>
              </header>
              ...
              <div className="mt-10 text-gov-body text-govgrey-800">
                <p className="font-semibold">(Under Secretary to the Government of India)</p>
                <p className="text-gov-table text-govgrey-600">Telephone: 011-2338 4567</p>
              </div>
